       ...
       <a class="navbar-brand" href="index.php">🏀 Sportify</a>
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="cart.php" class="cart-icon">
                ...
                <span class="cart-badge"></span> <!-- Dynamic cart count -->
            </a>
        </div>   
            <!-- Profile Dropdown -->
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link" href="n_home.php">🏠 Home</a></li>
                <li class="nav-item"><a class="nav-link" href="n_products.php">🛍 Products</a></li>
